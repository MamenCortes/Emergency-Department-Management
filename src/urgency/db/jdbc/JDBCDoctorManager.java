...
public class JDBCDoctorManager implements DoctorManager {
	...
	public void assignBox(int Doctor_id, int Box_id) { //habria q pasarle el date?
		...
		try {
			...
			System.out.println("Error assigning the doctor to a box.");
			e.printStackTrace();
		}
	...
	public void addDoctor(Doctor doctor) { //WORKS CORRECTLY
		...
		try {
			...
			System.out.println("Error in adding a doctor.");
			e.printStackTrace();
		}
	...
	@Override
	public List<Doctor> searchDoctorsBySurname(String surname) { //PARECE Q ENTRA EN BUCLE
		// TODO Auto-generated method stub
	...
	public Doctor getDoctor(int id) { //problema con especialidad, tipo speciality o string
		...
		try {
			...
			System.out.println("Error getting the doctor");
			e.printStackTrace();
		}
		return null;
	}
	...
	public List<Doctor> getDoctorsBySpeciality(String speciality_type){ //problem with the speciality
		...
		try {
			...
			System.out.println("Error in getting the doctor by its speciality.");
			e.printStackTrace();
		}
		return doctors;
	}
	...
	public static void main(String[] args) {
	    ...
	    d2 = new Doctor(3, "Carlos","Dominguez", s, true);
